...
> **Note (Jan 18, 2026)**: Documentation was consolidated to reduce redundancy. This guide remains the authoritative **Installation** reference. See [DOCUMENTATION_INDEX.md](../archive/DOCUMENTATION_INDEX.md) for complete documentation map.
...
See [USERGUIDE.md - Visit Keys Section](../user/USERGUIDE.md#understanding-visit-keys--same-patient-records) for user-facing explanation
